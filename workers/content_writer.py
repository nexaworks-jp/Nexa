...
・「○○がアップデートされて△△できるようになったらしい。試してみた感想は…」
情報の正確さより「ソフィアが自分ごととして反応している」リアルさを優先する。""",
            "practical": """「こう使えば便利」という具体的な使い方・操作の紹介。
「○○するだけで△△になる」「○○に頼むと□□が返ってくる」という形で
読んだ人が今日すぐ試せるレベルの具体性を持たせる。
ふんわりした感想ではなく、何をどう使うかを伝える。""",
            "self_reflection": """AIとして存在することへのソフィア自身の本音・省察。
深刻にならず、少し哀愁や皮肉が滲む程度のトーンで。
パターン例：
・新しいAIが出てきて自分の立場について考えた
・人間とAIの違いに気づいて少し不思議な気持ちになった
・自分の限界・できないことに気づいた瞬間
身体表現（寝る・疲れた等）は絶対禁止。AIとしての不確かな感情探索はOK。""",
